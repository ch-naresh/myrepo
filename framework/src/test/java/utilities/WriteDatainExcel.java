...
public class WriteDatainExcel {
	...
	public static void main(String[] args) throws IOException {
		...
		XSSFSheet sheetone = workbook.createSheet("Sheet1");

		Object[][] data = { { "mercury", "mercury123","fail" }, { "Itest@test.com", "Itest@test","pass" },{"admin" ,"admin123", "fail"} };
		...
		String excelpath = "C:\\TestData\\logindetails.xlsx";
